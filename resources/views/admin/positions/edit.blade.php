...
<div class="modal fade" id="PositionUpdateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="http://localhost:9000/api/position/" id="position_update_form">
      @csrf
