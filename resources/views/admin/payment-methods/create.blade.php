...
<div class="modal fade" id="PaymentMethodModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" action="{{app('shared')->get('base_url')}}/managment/payment-methods" id="paymentmethod_store_form">
      @csrf
        <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="file" class="dropify" name="icon" required data-parsley-required-message="kindly upload photo">
            </div>
        </div>
